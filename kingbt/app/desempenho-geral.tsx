...
const makeStyles = (Colors: ThemeColors) => StyleSheet.create({
  ...
  formChipTxt: { fontFamily: FontFamily.numberBold, fontSize: 13, fontWeight: '700' },

  l20Title:   { fontFamily: FontFamily.titleBold, fontSize: 15, color: Colors.text, marginBottom: Spacing.sm },
  l20Row:     { flexDirection: 'row', alignItems: 'center', gap: Spacing.sm, marginBottom: 6 },
  l20Label:   { fontFamily: FontFamily.body, fontSize: 13, color: Colors.muted, width: 60 },
  ...
  l20BarNum:  { fontFamily: FontFamily.numberBold, fontSize: 13, color: '#fff', paddingHorizontal: 6 },
  ...
  catBadgeTxt: { fontFamily: FontFamily.numberBold, fontSize: 13, fontWeight: '700' },
  ...
  catCloseTxt: { fontFamily: FontFamily.bodyMed, fontSize: 15, color: Colors.gold },
  ...
  groupRank: { fontFamily: FontFamily.numberBold, fontSize: 11, color: Colors.muted },
  groupPct:  { fontFamily: FontFamily.numberBold, fontSize: 13, fontWeight: '700' },
  groupCount: { fontFamily: FontFamily.body, fontSize: 11, color: Colors.muted, marginBottom: 6 },
  ...
  formatCount: { fontFamily: FontFamily.body, fontSize: 11, color: Colors.muted, marginTop: 2 },
  ...
  situationCount:  { fontFamily: FontFamily.body, fontSize: 11, color: Colors.muted },
