...
const makeStyles = (Colors: ThemeColors) => StyleSheet.create({
  ...
  wrLabel: { fontFamily: FontFamily.body, fontSize: 11, color: Colors.faint },
  ...
  matchResultTxt: { fontFamily: FontFamily.numberBold, fontSize: 13 },
  matchComp: { fontFamily: FontFamily.bodyMed, fontSize: 13, color: Colors.text },
  matchDate: { fontFamily: FontFamily.body, fontSize: 11, color: Colors.faint },
  matchScore: { fontFamily: FontFamily.numberBold, fontSize: 17 },
  ...
  histDate: { fontFamily: FontFamily.body, fontSize: 11, color: Colors.faint },
  ...
  statLabel: { fontFamily: FontFamily.bodyMed, fontSize: 13, color: Colors.muted },
  statSub: { fontFamily: FontFamily.body, fontSize: 11, color: Colors.faint },

  empty: { alignItems: 'center', paddingVertical: 48, gap: Spacing.sm },
  emptyIcon: { fontSize: 40 },
  emptyText: { fontFamily: FontFamily.body, fontSize: 15, color: Colors.muted, textAlign: 'center' },
});
