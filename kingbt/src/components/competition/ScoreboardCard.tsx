...
const makeSb = (Colors: ThemeColors) => StyleSheet.create({
  ...
  nextBadgeTxt: { fontFamily: FontFamily.numberBold, fontSize: 11, color: Colors.gold, letterSpacing: 1 },
  ...
  liveBadgeTxt: { fontFamily: FontFamily.numberBold, fontSize: 11, color: Colors.coral, letterSpacing: 1 },
  draftBadge: { backgroundColor: Colors.muted + '18', borderRadius: Radius.full, paddingHorizontal: Spacing.sm, paddingVertical: 2 },
  draftBadgeTxt: { fontFamily: FontFamily.numberBold, fontSize: 11, color: Colors.muted, letterSpacing: 1 },
